...
| Object identity is a string in history | label is written into `core_history`; wrong class can still proceed; take microwave/countertop loops | HiMe tags, Cortex language memory: still no stable identity contract | **EmbodiSkill / this Skill**: reject requested/returned conflicts; block non-pickupable takes | `verify_grounded_object`, `block_nonpickupable_take`, `grounding_contract_mode=referential_only` |
